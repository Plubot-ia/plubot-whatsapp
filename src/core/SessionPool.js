...
export class SessionPool extends EventEmitter {
  ...
  getMetrics() {
    return {
      ...this.stats,
      poolUtilization: this.pool.size > 0 ? (this.activeConnections.size / this.pool.size) * 100 : 0,
      avgAcquisitionTime: this.stats.acquired > 0 ? this.stats.totalAcquisitionTime / this.stats.acquired : 0,
    };
  }
