...
export class CircuitBreaker extends EventEmitter {
  constructor(options = {}) {
    ...
    this.options = {
      ...
      rollingWindowSize: options.rollingWindowSize || 10000,
  ...
  async execute(fn, ...args) {
    ...
    if (this.state === States.HALF_OPEN) {
      return this._handleHalfOpen(fn, args);
    }
    
    // Circuit is closed, execute normally
    return this._handleClosed(fn, args);
  }
