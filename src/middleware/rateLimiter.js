...
export class TieredRateLimiter {
  constructor(tiers = {}) {
    this.tiers = {
      anonymous: new RateLimiter({ maxRequests: 10, windowMs: 60000 }),
      basic: new RateLimiter({ maxRequests: 100, windowMs: 60000 }),
      premium: new RateLimiter({ maxRequests: 1000, windowMs: 60000 }),
      unlimited: null,
      ...tiers,
    };
  }
