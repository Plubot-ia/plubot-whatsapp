  ...
  async getDashboardMetrics() {
    ...
    const dashboard = {
      ...
      messages: {
        ...
        avgProcessingTime: this.extractHistogramAvg(metrics, 'plubot_whatsapp_message_processing_duration_seconds')
      },
      api: {
      ...
      resources: {
        memory: {
          rss: this.extractMetricValue(metrics, 'plubot_whatsapp_memory_usage_bytes', { type: 'rss' }),
          heapUsed: this.extractMetricValue(metrics, 'plubot_whatsapp_memory_usage_bytes', { type: 'heapUsed' })
        },
